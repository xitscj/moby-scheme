...
(define (register-htdp-beginner-bindings!)
  ...
  (register-toplevel-constant! 'null "plt_EMPTY")
  (register-toplevel-constant! 'empty "plt_EMPTY")
  (register-toplevel-constant! 'true "plt_TRUE")
  (register-toplevel-constant! 'false "plt_FALSE")
  (register-toplevel-constant! 'eof "plt_EOF")
  ...
  (let ([r (lambda (id arity (vararity? #f))
             (register-toplevel-function! id 
                                          ...
                                          vararity?
                                          (format "plt_~a"
                                                  (identifier->munged-arduino-identifier id))))])
